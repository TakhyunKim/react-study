...
interface SignUpPetInfoProps {
  userInfo: UserInfo;
  onNext: (petInfo: PetInfo) => void;
}

function SignUpPetInfo({ onNext }: SignUpPetInfoProps) {
  const { petInfo, disabledSubmitButton, handlePetFormChange } =
    useSignUpPetInfo();
